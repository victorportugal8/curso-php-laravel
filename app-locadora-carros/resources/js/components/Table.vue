            ...
            dadosFiltrados(){
                ...
                this.dados.map((item, chave) =>{
                    ...
                    campos.forEach(campo =>{
                        itemFiltrado[campo] = item[campo] //utilizando a sintaxe de array para atribuição de valores a objetos
                    })
                    dadosFiltrados.push(itemFiltrado)
                })
                
                return dadosFiltrados //retorna um array de objetos para ser percorrido
            }
        }
    }
</script>
