<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <!--início do card de busca de registros-->
                ...
                <!--fim do card de busca de registros-->            
                
                <!--início do card de busca de listagem de registros-->
                ...
                <!--fim do card de busca de listagem de registros-->
            </div>
        </div>
        ...
        methods: {
            ...
            paginacao(l){
                if(l.url){
                    ...
                    this.carregarLista() //requisitando novamente os dados para a API com base na URL atualizada
                }
            },
            carregarLista(){
            ...
            salvar(){
                ...
                //3 parâmetros: 1ºP -> URL(End Point) para onde faremos a requisição; 2ºP -> conteúdo da requisição; 3ºP -> configurações da requisição;
